...
<!-- source(paste0(dir_path, "/02_scripts/load_data/load_human_activities.R")) -->

<!-- source(paste0(dir_path, "/02_scripts/load_data/load_marine_boundaries.R")) -->
...
<!-- masterias_info <- read_csv(paste0(dir_path, "/RData/masterias_info.csv"), show_col_types = FALSE) -->

<!-- masterias_info <- masterias_info %>% remove_double_cols() -->

<!-- # masterias_stations <- read_csv(paste0(dir_path, "/RData/masterias_stations.csv"), show_col_types = FALSE) -->

<!-- masterias_ind_per_station <- read_csv(paste0(dir_path, "/RData/masterias_ind_per_station.csv"), show_col_types = FALSE) -->

<!-- masterias_detections <- read_csv(paste0(dir_path, "/RData/masterias_detections.csv"), show_col_types = FALSE) -->
...
<!-- deployments <- read_csv(paste0(dir_path, "/RData/deployments.csv"), show_col_types = FALSE) -->
