...
output:
  html_document:
    ...
    toc_depth: 2
subtitle: exploratory analysis progress of the DST data, master thesis Lotte Pohl, 27.2.2023
editor_options:
...
pal_dst <- colorNumeric(palette = "magma", domain = c(mpts_all$date_time %>% min(), masterias_detections_clean$date_time %>% max())) # mpts_all$date_time, masterias_detections_clean$date_time
...
map_dst <- leaflet::leaflet(
  ...
  addCircleMarkers(data = wrecks_BE %>% filter(Staat != "Geborgen"),
                   ...
                   group = "wrecks, OWFs, cables") %>%
  # add tag 295 #####
    addPolylines(data = mpts_all %>% filter(tag_serial_number == "1293295"),
  ...
  addPolylines(data = mpts_all %>% filter(tag_serial_number == "1293295"),
               ...
               group = "mode tracks") %>%
  addCircleMarkers(data = mpts_all %>% filter(tag_serial_number == "1293295"),
               lat = ~detection_latitude,
               lng = ~detection_longitude,
               ...
               group = "<span style=color:#D43F3A>tag 295</span>") %>%
  # add tag 304 #####
    addPolylines(data = mpts_all %>% filter(tag_serial_number == "1293304"),
               lat = ~detection_latitude,
               lng = ~detection_longitude,
               color = ~pal(tag_serial_number),
               weight = 3,
  ...
  addPolylines(data = mpts_all %>% filter(tag_serial_number == "1293304"),
               ...
               label = ~paste0(tag_serial_number, ", mode track"),
               group = "mode tracks") %>%
  addCircleMarkers(data = mpts_all %>% filter(tag_serial_number == "1293304"),
               lat = ~detection_latitude,
               lng = ~detection_longitude,
               fillColor = ~pal(tag_serial_number),
               radius = 5,
               ...
               group = "<span style=color:#EEA236>tag 304</span>") %>%
  # add tag 310 #####
    addPolylines(data = mpts_all %>% filter(tag_serial_number == "1293310"),
               lat = ~detection_latitude,
               lng = ~detection_longitude,
               color = ~pal(tag_serial_number),
               weight = 3,
  ...
  addPolylines(data = mpts_all %>% filter(tag_serial_number == "1293310"),
               ...
               label = ~paste0(tag_serial_number, ", mode track"),
               group = "mode tracks") %>%
  addCircleMarkers(data = mpts_all %>% filter(tag_serial_number == "1293310"),
               lat = ~detection_latitude,
               lng = ~detection_longitude,
               fillColor = ~pal(tag_serial_number),
               radius = 5,
               ...
               group = "<span style=color:#5CB85C>tag 310</span>") %>%
  # add tag 312 #####
    addPolylines(data = mpts_all %>% filter(tag_serial_number == "1293312"),
               lat = ~detection_latitude,
               lng = ~detection_longitude,
               color = ~pal(tag_serial_number),
               weight = 3,
  ...
  addPolylines(data = mpts_all %>% filter(tag_serial_number == "1293312"),
               ...
               label = ~paste0(tag_serial_number, ", mode track"),
               group = "mode tracks") %>%
  addCircleMarkers(data = mpts_all %>% filter(tag_serial_number == "1293312"),
               lat = ~detection_latitude,
               lng = ~detection_longitude,
               fillColor = ~pal(tag_serial_number),
               radius = 5,
               ...
               group = "<span style=color:#46B8DA>tag 312</span>") %>%
  # add tag 319 #####
    addPolylines(data = mpts_all %>% filter(tag_serial_number == "1293319"),
               lat = ~detection_latitude,
               lng = ~detection_longitude,
               color = ~pal(tag_serial_number),
               weight = 3,
  ...
  addPolylines(data = mpts_all %>% filter(tag_serial_number == "1293319"),
               ...
               label = ~paste0(tag_serial_number, ", mode track"),
               group = "mode tracks") %>%
  addCircleMarkers(data = mpts_all %>% filter(tag_serial_number == "1293319"),
               lat = ~detection_latitude,
               lng = ~detection_longitude,
               fillColor = ~pal(tag_serial_number),
               radius = 5,
               ...
               group = "<span style=color:#357EBD>tag 319</span>") %>%
  # add tag 322 #####
    addPolylines(data = mpts_all %>% filter(tag_serial_number == "1293322"),
               lat = ~detection_latitude,
               lng = ~detection_longitude,
               color = ~pal(tag_serial_number),
               weight = 3,
  ...
  addPolylines(data = mpts_all %>% filter(tag_serial_number == "1293322"),
               ...
               label = ~paste0(tag_serial_number, ", mode track"),
               group = "mode tracks") %>%
  addCircleMarkers(data = mpts_all %>% filter(tag_serial_number == "1293322"),
               lat = ~detection_latitude,
               lng = ~detection_longitude,
               fillColor = ~pal(tag_serial_number),
               radius = 5,
  ...
  # add tag 308 ####
    addPolylines(data = mpts_all %>% filter(tag_serial_number == "1293308"),
               lat = ~detection_latitude,
               lng = ~detection_longitude,
               color = "#B5B5B5",
               weight = 3,
  ...
  addPolylines(data = mpts_all %>% filter(tag_serial_number == "1293308"),
               ...
               label = ~paste0(tag_serial_number, ", mode track"),
               group = "mode tracks") %>%
  addCircleMarkers(data = mpts_all %>% filter(tag_serial_number == "1293308"),
               lat = ~detection_latitude,
               lng = ~detection_longitude,
  ...
  # add tag 321 ####
    addPolylines(data = mpts_all %>% filter(tag_serial_number == "1293321"),
               lat = ~detection_latitude,
               lng = ~detection_longitude,
               color = "#B5B5B5",
               weight = 3,
  ...
  addPolylines(data = mpts_all %>% filter(tag_serial_number == "1293321"),
               ...
               label = ~paste0(tag_serial_number, ", mode track"),
               group = "mode tracks") %>%
  addCircleMarkers(data = mpts_all %>% filter(tag_serial_number == "1293321"),
               lat = ~detection_latitude,
               lng = ~detection_longitude,
               fillColor = ~pal_dst(date_time),
               radius = 5,
...
data <- mpts_all %>% filter(date_time %>% between("2018-08-02" %>% as.POSIXct(tz = "UTC"), "2018-10-09" %>% as.POSIXct(tz = "UTC")),
...
# plot <-
  ggplot() +
  geom_point(data = press_temp_308 %>% filter(date_time %>% between("2018-08-02" %>% as.POSIXct(tz = "UTC"), "2018-10-09" %>% as.POSIXct(tz = "UTC"))), aes(x = date_time, y = -depth_m, color = temp_c)) +
  scale_y_continuous(breaks = c(0, -10, -20, -30, -40, -50, -60, -70)) +
  labs(y = "Depth in m", x = "Date", color = "Temperature in C") +
  scale_colour_distiller(palette ="RdYlBu") +
  theme_dark()
...
```{r tag308Channel}
#| include: true
data <- mpts_all %>% filter(date_time %>% between("2018-10-09" %>% as.POSIXct(tz = "UTC"), "2019-04-06" %>% as.POSIXct(tz = "UTC")),
                    tag_serial_number == "1293308")
...
# plot <-
  ggplot() +
  geom_point(data = press_temp_308 %>% filter(date_time %>% between("2018-10-09" %>% as.POSIXct(tz = "UTC"), "2019-04-06" %>% as.POSIXct(tz = "UTC"))), aes(x = date_time, y = -depth_m, color = temp_c)) +
  scale_y_continuous(breaks = c(0, -10, -20, -30, -40, -50, -60, -70)) +
  labs(y = "Depth in m", x = "Date", color = "Temperature in C") +
  scale_colour_distiller(palette ="RdYlBu") +
  theme_dark()
...
```{r tag308ChannelWS}
#| include: true
data <- mpts_all %>% filter(date_time %>% between("2019-04-06" %>% as.POSIXct(tz = "UTC"), "2019-05-12" %>% as.POSIXct(tz = "UTC")),
                    tag_serial_number == "1293308")
...
# plot <-
  ggplot() +
  geom_point(data = press_temp_308 %>% filter(date_time %>% between("2019-04-06" %>% as.POSIXct(tz = "UTC"), "2019-05-12" %>% as.POSIXct(tz = "UTC"))), aes(x = date_time, y = -depth_m, color = temp_c)) +
  scale_y_continuous(breaks = c(0, -10, -20, -30, -40, -50, -60, -70)) +
  labs(y = "Depth in m", x = "Date", color = "Temperature in C") +
  scale_colour_distiller(palette ="RdYlBu") +
  theme_dark()
...
data <- mpts_all %>% filter(date_time %>% between("2019-05-13" %>% as.POSIXct(tz = "UTC"), "2019-06-12" %>% as.POSIXct(tz = "UTC")),
                    tag_serial_number == "1293308")
...
# plot <-
  ggplot() +
  geom_point(data = press_temp_308 %>% filter(date_time %>% between("2019-05-13" %>% as.POSIXct(tz = "UTC"), "2019-06-12" %>% as.POSIXct(tz = "UTC"))), aes(x = date_time, y = -depth_m, color = temp_c)) +
  scale_y_continuous(breaks = c(0, -10, -20, -30, -40, -50, -60, -70)) +
  labs(y = "Depth in m", x = "Date", color = "Temperature in C") +
  scale_colour_distiller(palette ="RdYlBu") +
  theme_dark()
...
data <- mpts_all %>% filter(date_time %>% between("2019-06-12" %>% as.POSIXct(tz = "UTC"), "2019-08-03" %>% as.POSIXct(tz = "UTC")),
                    tag_serial_number == "1293308")
...
# plot <-
  ggplot() +
  geom_point(data = press_temp_308 %>% filter(date_time %>% between("2019-06-13" %>% as.POSIXct(tz = "UTC"), "2019-08-03" %>% as.POSIXct(tz = "UTC"))), aes(x = date_time, y = -depth_m, color = temp_c)) +
  scale_y_continuous(breaks = c(0, -10, -20, -30, -40, -50, -60, -70)) +
  labs(y = "Depth in m", x = "Date", color = "Temperature in C") +
  scale_colour_distiller(palette ="RdYlBu") +
  theme_dark()
...
data <- mpts_all %>% filter(date_time %>% between("2018-07-19" %>% as.POSIXct(tz = "UTC"), "2018-10-22" %>% as.POSIXct(tz = "UTC")),
...
# plot <-
  ggplot() +
  geom_point(data = press_temp_321 %>% filter(date_time %>% between("2018-07-19" %>% as.POSIXct(tz = "UTC"), "2018-10-22" %>% as.POSIXct(tz = "UTC"))), aes(x = date_time, y = -depth_m, color = temp_c)) +
  scale_y_continuous(breaks = c(0, -10, -20, -30, -40, -50, -60, -70)) +
  labs(y = "Depth in m", x = "Date", color = "Temperature in C") +
  scale_colour_distiller(palette ="RdYlBu") +
  theme_dark()
...
data <- mpts_all %>% filter(date_time %>% between("2018-10-23" %>% as.POSIXct(tz = "UTC"), "2019-04-23" %>% as.POSIXct(tz = "UTC")),
                    tag_serial_number == "1293321")
...
# plot <-
  ggplot() +
  geom_point(data = press_temp_321 %>% filter(date_time %>% between("2018-10-23" %>% as.POSIXct(tz = "UTC"), "2019-04-23" %>% as.POSIXct(tz = "UTC"))), aes(x = date_time, y = -depth_m, color = temp_c)) +
  scale_y_continuous(breaks = c(0, -10, -20, -30, -40, -50, -60, -70)) +
  labs(y = "Depth in m", x = "Date", color = "Temperature in C") +
  scale_colour_distiller(palette ="RdYlBu") +
  theme_dark()
...
data <- mpts_all %>% filter(date_time %>% between("2019-04-23" %>% as.POSIXct(tz = "UTC"), "2019-05-10" %>% as.POSIXct(tz = "UTC")),
                    tag_serial_number == "1293321")
...
# plot <-
  ggplot() +
  geom_point(data = press_temp_321 %>% filter(date_time %>% between("2019-04-23" %>% as.POSIXct(tz = "UTC"), "2019-05-10" %>% as.POSIXct(tz = "UTC"))), aes(x = date_time, y = -depth_m, color = temp_c)) +
  scale_y_continuous(breaks = c(0, -10, -20, -30, -40, -50, -60, -70)) +
  labs(y = "Depth in m", x = "Date", color = "Temperature in C") +
  scale_colour_distiller(palette ="RdYlBu") +
  theme_dark()
...
data <- mpts_all %>% filter(date_time %>% between("2019-05-10" %>% as.POSIXct(tz = "UTC"), "2019-05-29" %>% as.POSIXct(tz = "UTC")),
                    tag_serial_number == "1293321")
...
# plot <-
  ggplot() +
  geom_point(data = press_temp_321 %>% filter(date_time %>% between("2019-05-10" %>% as.POSIXct(tz = "UTC"), "2019-05-28" %>% as.POSIXct(tz = "UTC"))), aes(x = date_time, y = -depth_m, color = temp_c)) +
  scale_y_continuous(breaks = c(0, -10, -20, -30, -40, -50, -60, -70)) +
  labs(y = "Depth in m", x = "Date", color = "Temperature in C") +
  scale_colour_distiller(palette ="RdYlBu") +
  theme_dark()
...
data <- mpts_all %>% filter(date_time %>% between("2019-05-28" %>% as.POSIXct(tz = "UTC"), "2019-09-21" %>% as.POSIXct(tz = "UTC")),
                    tag_serial_number == "1293321")
...
# plot <-
  ggplot() +
  geom_point(data = press_temp_321 %>% filter(date_time %>% between("2019-05-28" %>% as.POSIXct(tz = "UTC"), "2019-09-21" %>% as.POSIXct(tz = "UTC"))), aes(x = date_time, y = -depth_m, color = temp_c)) +
  scale_y_continuous(breaks = c(0, -10, -20, -30, -40, -50, -60, -70)) +
  labs(y = "Depth in m", x = "Date", color = "Temperature in C") +
  scale_colour_distiller(palette ="RdYlBu") +
  theme_dark()
...
data <- mpts_all %>% filter(date_time %>% between("2019-09-21" %>% as.POSIXct(tz = "UTC"), "2019-11-15" %>% as.POSIXct(tz = "UTC")),
                    tag_serial_number == "1293321")
...
# plot <-
  ggplot() +
  geom_point(data = press_temp_321 %>% filter(date_time %>% between("2019-09-21" %>% as.POSIXct(tz = "UTC"), "2019-11-15" %>% as.POSIXct(tz = "UTC"))), aes(x = date_time, y = -depth_m, color = temp_c)) +
  scale_y_continuous(breaks = c(0, -10, -20, -30, -40, -50, -60, -70)) +
  labs(y = "Depth in m", x = "Date", color = "Temperature in C") +
  scale_colour_distiller(palette ="RdYlBu") +
  theme_dark()
